...
def usage(fname):
  """Prints usage """
  print ""
  print "Program: %s (fetches MGA reports from Clarity LIMS)" % (fname,)
  print "Version: %s" % __version__
  print "Usage:   %s [-t/--test] <run> <lane> <dest> [filename prefix] " % (fname,)
...
if __name__ == '__main__':
  ...
  (RUN, FLOWLANE, DESTINATION, NAMEPREFIX) = process_cmdline(sys.argv)
  fetch_mga(RUN, FLOWLANE, DESTINATION, NAMEPREFIX)
